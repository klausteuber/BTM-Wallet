...
export enum HandOffActivityType {
  ReceiveOnchain = 'com.americabitcoinatm.wallet.receiveonchain',
  Xpub = 'com.americabitcoinatm.wallet.xpub',
  ViewInBlockExplorer = 'com.americabitcoinatm.wallet.blockexplorer',
}
