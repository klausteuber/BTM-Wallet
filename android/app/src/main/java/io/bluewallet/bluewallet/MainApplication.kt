...
import com.americabitcoinatm.wallet.components.segmentedcontrol.CustomSegmentedControlPackage
...
class MainApplication : Application(), ReactApplication {
    ...
    override fun onCreate() {
        super.onCreate()
        sharedPref = getSharedPreferences("group.com.americabitcoinatm.wallet", Context.MODE_PRIVATE)
